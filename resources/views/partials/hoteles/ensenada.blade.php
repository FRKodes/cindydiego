<div class="panel panel-default">
  <div class="panel-heading">
    <h4 class="panel-title">
      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#HotelesEnsenada">
        + HOTELES ENSENADA
      </a>
    </h4>
  </div>
  <div id="HotelesEnsenada" class="panel-collapse collapse">
    <div class="panel-body">
      
      <div class="item">
      	<h3 class="title">Hotel Las Rosas</h3>	
      	<p class="text">
      ...
      <div class="item">
      	<h3 class="title">Hotel Cortez </h3>	
      	<p class="text">
      ...
      <div class="item">
      	<h3 class="title">Hotel Corona &amp; Spa</h3>	
      	<p class="text">
      		Tel.: (646) 176-0901<br>
      		Clave de reservación:<br>
      ...
      <div class="item">
      	<h3 class="title">Hotel Coral &amp; Marina</h3>	
      	<p class="text">
      ...
      <div class="item">
      	<h3 class="title">Hotel Misión Santa Isabel</h3>	
      	<p class="text">
      		Tel.: 646 178 3616<br>
      		Clave de reservación:<br>
      		Pendiente <br>
      ...
      <div class="item">
      	<h3 class="title">San Nicolas Hotel &amp; Casino </h3>
      	<p class="text">
      ...
      <div class="item">
      	<h3 class="title">Best Western El Cid</h3>	
      	<p class="text">
      		Tel.: 01 646 178 2401<br>
      		Clave de reservación:<br>
      		Pendiente <br>
      		<a href="http://www.hotelelcid.com.mx/" target="_blank" title="Visitar Sitio Web Hotel El Cid">Visitar Sitio Web</a>
      	</p>
      	<figure><a target="_blank" title="Visitar Sitio Web Hotel El Cid" href="http://www.hotelelcid.com.mx/"><img src="images/logo-hotel-el-cid.jpg" alt="logo hotel El Cid"></a></figure>
      </div>
