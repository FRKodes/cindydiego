    <div class="panel panel-default">
      ...
      <div id="HotelesGdpe" class="panel-collapse collapse">
        <div class="panel-body">
			...
			<div class="item">
				<h3 class="title">Encuentro Guadalupe Antiresort</h3>	
				<p class="text">
			...
			<div class="item">
				<h3 class="title">Hotel Boutique Adobe Guadalupe</h3>	
				<p class="text">
			...
			<div class="item">
				<h3 class="title">Hotel Boutique Villa del Valle</h3>	
				<p class="text">
			...
			<div class="item">
				<h3 class="title">Rancho Cien Piedras (Cabaña sobre Ruta del Vino)</h3>	
				<p class="text">
			...
			<div class="item">
				<h3 class="title">Quinta Casa Blanca </h3>	
				<p class="text">
					Tel.: (646) 1164603<br>
					Clave de reservación:<br>
					N/A<br>
			...
			<div class="item">
				<h3 class="title">Terra del valle </h3>	
				<p class="text">
			...
			<div class="item">
				<h3 class="title">Casa Mayoral </h3>	
				<p class="text">
			...
			<div class="item">
				<h3 class="title">Hotel Meson del vino </h3>	
				<p class="text">
			...
			<div class="item">
				<h3 class="title">Hotel Rancho Mariposa</h3>	
				<p class="text">
			...
			<div class="item">
				<h3 class="title">Quinta Santa, Teresa Ensenada</h3>	
				<p class="text">
			...
			<div class="item">
				<h3 class="title">Viñas del Tigre</h3>	
				<p class="text">
