                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style='text-align:left'>
                                                        ...
                                                        <p><b>Confirma?</b>  {{ Input::get('confirm') }} </p>
                                                        <p><b>Mensaje:</b>  {{ Input::get('message') }} </p>
                                                        <p><a style='color:#3a6f8f;text-decoration:none;' href='http://www.cindybouquetboda.com' target='_blank'><span style='text-transform:uppercase;'></span><br>CindyBouquet Boda</a></p>
                                                    </td>
                                                    <td width='10'></td>
                                                </tr>
                                            </tbody>
